...
function JobCategory() {
  return (
    <div className='pb-5 mt-20'>
      ...
      <div className='text-lg mb-10 text-mine-shaft-300 text-center w-1/2 mx-auto'>Explore amazing job opportunities tailored to your skills. Start your Journey today.</div>
